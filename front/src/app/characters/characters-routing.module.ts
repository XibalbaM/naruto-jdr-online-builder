...
const routes: Routes = [
    {path: '', component: ListComponent, resolve: {user: UserResolver}, title: "Liste de personnages — Naruto jdr"},
    {
        path: 'creation', children: [
    ...
    {
        path: ':characterId/base/:id', component: BaseComponent, data: {navbar: "character", bgClass: "no-repeat-image-bg"}, resolve: {user: UserResolver},
        title: "Base — Fiche de personnage — Naruto jdr"
    },
    {
        path: ':characterId/competence/:id', component: SkillComponent, data: {navbar: "character", bgClass: "no-repeat-image-bg"}, resolve: {user: UserResolver},
        title: "Compétence — Fiche de personnage — Naruto jdr"
    },
    {
        path: ':characterId/lignee', component: LineComponent, data: {navbar: "characterWithNav", bgClass: 'image-bg'},
        title: "Fiche de personnage — Naruto jdr"
    },
    {
        path: ':characterId/details', component: EditDetailsComponent, data: {navbar: "none", bgClass: '!bg-black'}, resolve: {user: UserResolver},
        title: "Fiche de personnage — Modification — Naruto jdr"
    },
    {
        path: ':characterId', component: EditComponent, data: {navbar: "characterWithNav", bgClass: "large-no-repeat-image-bg"}, resolve: {user: UserResolver},
        title: "Fiche de personnage — Naruto jdr"
    }
];
