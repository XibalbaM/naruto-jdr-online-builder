...
export class DataService {
  ...
  /**
   * Call {@link getData} for each dataId in {@link datas}
   */
  addData() {
    for (const dataId in this.datas) {
      this.getData(dataId as keyof typeof DataService.prototype.datas);
    }
  }
   ...
   * @param dataId
   */
  getData(dataId: keyof typeof DataService.prototype.datas) {
